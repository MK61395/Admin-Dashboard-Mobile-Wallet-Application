...
function ProjectDashboard() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        const url = editMode ? `/project/updateProject/${editingId}` : '/project/addProject';
    ...
    return (
        <div className="dashboard-content">
            ...
            <form onSubmit={handleSubmit}>
                <input type="number" name="adminID" placeholder="Admin ID" value={formData.adminID} onChange={handleInputChange} required />
                ...
                <input type="number" name="targetAmount" placeholder="Target Amount" value={formData.targetAmount} onChange={handleInputChange} required />
                ...
                <input type="date" name="startDate" placeholder="Start Date" value={formData.startDate} onChange={handleInputChange} required />
                <input type="date" name="endDate" placeholder="End Date" value={formData.endDate} onChange={handleInputChange} required />
                
                <input type="number" name="totalAmountInvested" placeholder="Total Amount Invested" value={formData.totalAmountInvested} onChange={handleInputChange} />
                <input type="number" name="roi" placeholder="ROI" value={formData.roi} onChange={handleInputChange} />
                <input type="number" name="totalRevenueGenerated" placeholder="Total Revenue" value={formData.totalRevenueGenerated} onChange={handleInputChange} />
